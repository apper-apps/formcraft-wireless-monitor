...
{field.options?.map((option, i) => (
                                <label key={`radio-field-${index}-option-${i}-${option}-${field.type}`} className="flex items-center">
...
<div className="space-y-2">
{field.options?.map((option, i) => (
<label key={`checkbox-field-${index}-option-${i}-${option}-${field.type}`} className="flex items-center">
